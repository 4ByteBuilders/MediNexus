      ...
      <div className="mr-5 mt-8 flex flex-col gap-5">
        {prescriptions.reverse().map((prescription, idx) => {
          return (
            <div
              key={idx}
              className="bg-slate-200 flex flex-row items-center justify-between gap-2 p-2 rounded-lg w-full px-4 hover:bg-slate-300 transition-colors"
            >
              <div className="flex flex-col gap-2 p-2">
                ...
                <p className="">
                  Hospital: {prescription.createdbyHospital.name}
                </p>
                <p className="">
                  Created date:
                  <span> {formatDateString(prescription.createdAt)}</span>
                </p>
              </div>
              <div className="flex flex-col items-center gap-2">
                <p className="font-bold">
                  Assigned to {prescription.doctorId.name}
                </p>
                <Dialog>
                  <DialogTrigger>
                        ...
                        <div className="flex flex-col gap-2 items-center border-2 border-black rounded-lg py-4">
                          ...
                          <div className="flex flex-col items-center w-full">
                            ...
                            <div className="grid grid-cols-2 w-full px-10 text-base">
                              ...
                              <p className="text-black ">
                                Degree: {prescription.doctorId.degree}
                              </p>
                              <p className="text-black ">
                              ...
                              <p className="text-black ">
                                Speciality: {prescription.doctorId.speciality}
                              </p>
                            </div>
                          </div>
                          <div className="border-b-2 border-green-800 w-2/3 " />
                          ...
                          <div className="flex flex-col items-center w-full">
                            ...
                            <div className="grid grid-cols-2 gap-x-9 min-w-0 w-full px-10 text-base">
                              <p className="text-black whitespace-nowrap overflow-hidden text-overflow-ellipsis">
                            ...
                            <br />
                            <div className="grid grid-cols-2 gap-x-32 min-w-0 w-full px-10 text-base">
                              <p className="text-black font-bold text-1.5xl">
                                Test ID
                              </p>
                              <p className="text-black font-bold text-1.5xl">
                                View
                            ...
                            {prescription.testIds.map((test, idx) => {
                              return (
                                <div
                                  key={idx}
                                  className="grid grid-cols-2 gap-x-9 min-w-0 w-full px-10 text-base"
                                >
                                  <p className="text-black whitespace-nowrap overflow-hidden text-overflow-ellipsis">
                                    {test}
                                  </p>
